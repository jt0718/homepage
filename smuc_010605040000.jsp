...
<div class="tab_dept02">
	<ul>
		...
		<li><a href="/mbs/smuc/subview.jsp?id=smuc_010605050000">교직운영팀</a> </li>
		<li class="on"><a href="/mbs/smuc/subview.jsp?id=smuc_010605040000">교원양성지원센터</a> </li>
	</ul>
</div>
...
<table class="tb_data01 mb20" summary="기관정보 위치, 전화, 홈페이지, 팩스, 업무내용">
	...
	<tbody>
		...
		<tr>
			<th>업무내용</th>
			<td class="long" colspan="3">- 교직과정 이수예정자 선발에 관한 업무<br />
			- 교육실습(현장실습 및 교육봉사)에 관한 업무<br />
			- 교수·학습자료실 운영에 관한 업무<br />
			- 교직과정 예산운영에 관한 업무<br />
...
<table class="tb_data01 mb20" summary="근무자 정보 이름, 직위, 전화번호, 이메일, 담당업무">
	...
	<tbody>
		<tr>
			...
			<td>소장</td>
			<td>041-550-5137</td>
			<td><a href="mailto:jbyoun@smu.ac.kr">jbyoun@smu.ac.kr</a> </td>
			<td class="long"></td>
		</tr>
	</tbody>
</table>
